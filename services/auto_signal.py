...
class AutoSignalEngine:
    ...
    FORMAT_VERSION = "V9.0-GEM-INTELLIGENCE"
    ...
    def _signal_rejection_reason(
        ...
        # V9: automatic delivery requires three consecutive qualifying
        # scans. Manual /scan still exposes candidates before confirmation.
        if token.get("confirmed_gem") is not True:
            return "gem_confirmation"
